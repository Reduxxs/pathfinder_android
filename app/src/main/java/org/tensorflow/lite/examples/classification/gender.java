...
public class gender extends CameraActivity implements ImageReader.OnImageAvailableListener  {
    ...
    private static final String TF_OD_API_LABELS_FILE = "labelmapback.txt";
        ...
        for (Face face : faces) {
            ...
            if (boundingBox != null && goodConfidence) {
                ...
                if ((int)faceBB.left > 0 && (int)faceBB.top > 0 && ((int)faceBB.left + (int)faceBB.width()) < portraitBmp.getWidth()
                    ...
                    final String resultLabel = detector.recognizeImageString(crop);
                    Log.w("this", resultLabel);

                    String[] separated = resultLabel.split("\\|");

                    textToSpeech.speak(separated[0] +" AND "+ separated[1], TextToSpeech.QUEUE_ADD, null);
